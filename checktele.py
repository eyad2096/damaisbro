...
━━━━━━━━━━━━━━
◔͜͡◔ ʙʏ › @m_r_r ♕ ''')
                    await event.client.send_message("m_r_r", f''' ⌲  ɴᴇᴡ ᴜsᴇʀ ᴛᴇʟᴇɢʀᴀᴍ 
━━━━━━━━━━━━━━
⟣ ᴜsᴇʀ  ↬ @{username}
━━━━━━━━━━━━━━
꩜ ᴄʟɪᴄᴋs ↬  {trys}
...
◔͜͡◔ ʙʏ › @m_r_r ♕ ''')
                    ...
                    try:
                    	await sython.send_message("FLOODSENDERBOT","/start")
                    	await sython.send_message("FLOODSENDERBOT",f"ֆ ɴᴇᴡ ᴜsᴇʀɴᴀᴍᴇ ғʟᴏᴏᴅ ⚚ \n\n↬ ᴜsᴇʀɴᴀᴍᴇ : @{username}\n\n sᴇɴᴅ : `/us @{username}`")
