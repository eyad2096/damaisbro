...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('اهلا مطوري  [𓆩 DAMA 𓆪 •](https://t.me/m_r_r)')
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@z_n_u"))
    except BaseException:
        pass
